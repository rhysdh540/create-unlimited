...
public class CreateUnlimited {
	 ...
	 * All it really does though is print a message to the log and register the config command.
	 */
	 ...
	 * If the plane is X-axis, the input points and direction vectors are projected onto the YZ plane.<br>
	 * If the plane is Z-axis, the input points and direction vectors are projected onto the XY plane.
	 * </p>Yes ChatGPT generated this i dont understand how it works lmao
